...
class AIChatAssistantAuthorityPage extends StatefulWidget {
  const AIChatAssistantAuthorityPage({super.key});

  @override
  _AIChatAssistantPageState createState() => _AIChatAssistantPageState();
}

class _AIChatAssistantPageState extends State<AIChatAssistantAuthorityPage> {
